...
export class QuoteService{
    ...
    quotes: Quote[] = [  
        new Quote(uuid(),'The greatest glory in living lies not in never falling, but in rising every time we fall.', 'Nelson Mandela',0,0,'Dun Shivachi',new Date(2021,3,28),false),
        new Quote(uuid(),'The way to get started is to quit talking and begin doing.', 'Walt Disney',0,0,'Dun shivachi',new Date(2021,3,27),false),
        new Quote(uuid(),'If life were predictable it would cease to be life, and be without flavor.', 'Eleanor Roosevelt',0,0,'Dun Shivachi',new Date(2020,8,16),false),
        new Quote(uuid(),'If you set your goals ridiculously high and it\'s a failure, you will fail above everyone else\'s success.', 'James Cameron',0,0,'Dun Shivachi',new Date(2021,3,28),false),
    ];
